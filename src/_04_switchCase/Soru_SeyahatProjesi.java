   ...
   todo    Frankfurt girildiyse,
      ...
      "Rota = Köln" yazdırın.
       ...
       case:1  ise
        ...
        double bakiye = 100;
        double frUcret = (double) (60 / 20) * 5;
        double klUcret = (double) (80 / 20) * 5;
        ...
        switch (hedef) {
                ...
                switch (kisi) {
                    ...
                    case 2:
                        System.out.println("2 kişilik bilet talep ettiniz " +
                                "bilet tutarınız : " + (frUcret * 2) + " EURO" + " güncel bakıyeniz: " +
                                (bakiye -= frUcret * 2)+" EURO");
            ...
            case "KOLN":
                ...
                switch (kisi1) {
                    ...
                    case 2:
                        System.out.println("2 kişilik bilet talep ettiniz " +
                                "bilet tutarınız : " + (klUcret * 2) + " EURO " + "güncel bakıyeniz: " +
                                (bakiye -= klUcret * 2)+" EURO");
