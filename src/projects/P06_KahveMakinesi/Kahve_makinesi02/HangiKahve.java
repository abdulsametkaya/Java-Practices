...
public class HangiKahve {
    ...
    private void kahveCikis() {
        Kahve kh = new Kahve("1", kahve.get(Integer.parseInt(no) - 1).getKahveAdi(),
                arrBardak[Integer.parseInt(bardak) - 1],
                arrSut[Integer.parseInt(sut) - 1],
                arrSeker[Integer.parseInt(seker) - 1]);
        secilenKahve.add(kh);
